export const siteContent = {
  ...
  hero: {
    ...
    backgroundImages: [
      ...
      "/images/hero-bg-7.webp",
      "/images/hero-bg-8.webp",
      "/images/hero-bg-9.webp",
      "/images/hero-bg-10.webp",
      "/images/hero-bg-11.webp",
      "/images/hero-bg-12.webp",
      "/images/hero-bg-13.webp",
      "/images/hero-bg-14.webp",
    ],
